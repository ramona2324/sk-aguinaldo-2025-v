...
<!--            </nav>-->
<!--        </header>-->
        <div class="flex flex-col w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <img src="/storage/sk-aguinaldo-logo.png" alt="sk-aguinaldo-logo" class="mb-4 w-50 h-50">
            <h1 class="mb-1 font-medium text-5xl text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]">SK AGUINALDO</h1>
            <h3 class="mb-4 font-medium text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]">Activity Array and Attendance Monitoring System</h3>
            <nav class="mt-5 flex items-center justify-end gap-4">
                <Link v-if="$page.props.auth.user" :href="route('dashboard')" class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
                    Dashboard
                </Link>
                <template v-else>
